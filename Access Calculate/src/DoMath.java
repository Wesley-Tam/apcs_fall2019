...
public class DoMath {
	public static void main(String[] args) {
		...
		//System.out.println(Calculate.toImproperFrac(1000000, 10000000, 19999999));
		//System.out.println(Calculate.toMixedNum(7, -1));
		//System.out.println(Calculate.foil(2, 3, 6, -7, "x"));
		//System.out.println(Calculate.isDivisibleBy(6, 6));
		//System.out.println(Calculate.absValue(0));
		//System.out.println(Calculate.max(-1, -5, 1000));
		//System.out.println(Calculate.min(4, -1));
		//System.out.println(Calculate.round2(-7.89478));
		//System.out.println(Calculate.exponent(6, 7));
		//System.out.println(Calculate.factorial(9));
		//System.out.println(Calculate.isPrime(1));
		System.out.println(Calculate.gcf(-117903, 2664));		//will negative numbers be tested?
